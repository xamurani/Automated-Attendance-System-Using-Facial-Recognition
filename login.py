...
class login_window:
  def __init__(self,root):
      ...
      # inserting the bg image
      top_img = Image.open(r"DSA_project_Ali\bg1.jpg")
      ...
      f_lbl.place(x = 0, y = 0, width = int(screen_width), height = int(screen_height) - 30)

      frame= Frame(self.root, bg="gray66")
      frame.place(x=610,y=170,width=340,height=450)

      img1=Image.open(r"DSA_project_Ali\acc.png")
      ...
      # icon images
      img2=Image.open(r"DSA_project_Ali\acc.png")
      ...
      img3=Image.open(r"DSA_project_Ali\lock-512.png")
  ...
  def login(self):
    if self.txtuser.get()=="" or self.txtpass.get()=="":
      ...
      messagebox.showinfo("info", "Access Gained.", parent = self.root)
    else:
    ...
    if self.txtuser.get()=="":
     ...
     # print(row)
      ...
      if row==None:
        ...
        self.root2.configure(bg = "gray66")
        self.root2.resizable(False, False)

        l=Label(self.root2,text="Forget Password",font=("times new roman",20, "bold"),fg="black",bg="gray66")
        l.place(x=0,y=10,relwidth=1)
        security_Q=Label(self.root2,text="Secutiry Question",font=("times new roman",15,"bold"), bg="gray66")
        ...
        security_A=Label(self.root2,text="Security Answer",font=("times new roman",15,"bold"), bg="gray66")
        security_A.place(x=50,y=150)
        self.txt_security=ttk.Entry(self.root2,font=("times new roman",15,"bold"))
        self.txt_security.place(x=50,y=180,width=250)

        new_password=Label(self.root2,text="New Password",font=("times new roman",15,"bold"), bg="gray66")
        new_password.place(x=50,y=220)
        self.txt_newpass=ttk.Entry(self.root2,font=("times new roman",15,"bold"))
        self.txt_newpass.place(x=50,y=250,width=250)

        btn=Button(self.root2,text="Reset",command=self.reset_pass,font=("times new roman",15,"bold"), bg="black",foreground="white")
...
class register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"DSA_project_Ali\wallpaperflare.com_wallpaper (2).jpg")
        bg_lbl=Label(self.root,image=self.bg)
        bg_lbl.place(x=0,y=0,relwidth=1,relheight=1)

        #creating image
        self.bg1=ImageTk.PhotoImage(file=r"DSA_project_Ali\bg.jpeg")
        left_lbl=Label(self.root,image=self.bg1)
        left_lbl.place(x=200,y=150,width=470,height=550)

        #main Frame 
        frame =Frame(self.root,bg="White",)
        frame.place(x=670,y=150,width=800,height=550)
      ...
      if self.var_fname.get()==""or self.var_email.get==""or self.var_securityQ.get=="":
          ...
          try:
              ...
              if row!=None:
                  ...
                  messagebox.showinfo("info","Registered Successfully", parent = self.root)
                  self.root.withdraw()
              conn.commit()
